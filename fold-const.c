...
#ifdef TMS34010
	lbitpos = (lbitpos & ~7) * GSP8 + (lbitpos & 7);
/*	warning("I'm worried"); */
#endif
...
#ifdef TMS34010
	rbitpos = (rbitpos & ~7) * GSP8 + (rbitpos & 7);
	warning("I'm worried 2");
#endif
...
/* AKPM */
if ((TREE_CODE(arg0) == INTEGER_CST && TREE_CODE(arg1) == ADDR_EXPR) ||
    (TREE_CODE(arg0) == ADDR_EXPR && TREE_CODE(arg1) == INTEGER_CST) ||
    (TREE_CODE(arg0) == ADDR_EXPR && TREE_CODE(arg1) == POINTER_TYPE))
	{
		warning("fold problems\n");
		return expr;
	}

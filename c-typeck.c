...
#ifdef TMS34010
	  index = build_binary_op(MULT_EXPR, index, size_int(GSP8), 0);
#endif
  ...
  if (code0 != ERROR_MARK && code1 != ERROR_MARK)
  {
	if (code == PLUS_EXPR || code == MINUS_EXPR)
	{
		if (code0 == POINTER_TYPE && code1 == INTEGER_TYPE)
			arg2 = build_binary_op(MULT_EXPR, arg2, size_int(GSP8), 0);
		if (code0 == INTEGER_TYPE && code1 == POINTER_TYPE)
			arg1 = build_binary_op(MULT_EXPR, arg1, size_int(GSP8), 0);
	}
  }
#endif
  return _parser_build_binary_op (code, arg1, arg2);
}

tree
_parser_build_binary_op (code, arg1, arg2)
     enum tree_code code;
     tree arg1, arg2;
{
	...
	subcode = (subcode == PLUS_EXPR ? MINUS_EXPR : PLUS_EXPR);
	 ...
	 can result in a sum or difference with different type args.  */
      ...
      intop = convert (int_type, TREE_OPERAND (intop, 0));
		...
		size_exp = build_binary_op(MULT_EXPR, size_exp, size_int(GSP8), 1);
#endif
...
#ifdef TMS34010
	  if (modifycode == PLUS_EXPR || modifycode == MINUS_EXPR)
	  {
		if (TREE_CODE(lhstype) == POINTER_TYPE)
		{	/* we have 'ptr += something'.  Scale 'something' */
			newrhs = build_binary_op(
						modifycode,
						lhs,
						build_binary_op(
							MULT_EXPR,

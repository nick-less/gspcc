     ...
     rtx adjust;
{
  ...
  if (GET_CODE(adjust) == CONST_INT)
	adjust8 = GEN_INT(INTVAL(adjust) * GSPmult);
  else
	adjust8 = expand_binop(SImode, smul_optab, adjust,
					GEN_INT(GSPmult), 0, 0, OPTAB_LIB_WIDEN);
#endif
...
#endif
#ifdef TMS34010
		       stack_pointer_rtx, adjust8, stack_pointer_rtx, 0,
#else
...
void
anti_adjust_stack (adjust, GSPmult)
     rtx adjust;
{
  rtx temp;
#ifdef TMS34010
